...
- Toggle a **vegetation height overlay** (Meta/WRI CHMv2 canopy, ~1 m) over the current view with an opacity slider (Terrain tab → *Canopy & Visibility*)
